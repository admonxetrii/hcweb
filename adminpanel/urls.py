...
urlpatterns = [
    ...
    path('certificates/', views.certificates, name="admincertificates"),
    path('del-certificate/<int:id>', views.delcertificates, name="delcertificates"),
    path('equipments/', views.equipments, name="adminequipments"),
    path('del-equipments/<int:id>', views.delequipments, name="delequipments"),
